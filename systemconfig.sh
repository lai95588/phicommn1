...
sudo apt install bluetooth avahi-daemon python3-venv  python3-pip python3 libbluetooth-dev build-essential libssl-dev libffi-dev  python-dev libudev-dev ffmpeg -y;
